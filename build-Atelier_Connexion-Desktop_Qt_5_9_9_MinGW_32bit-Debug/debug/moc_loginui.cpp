...
#include "../../../../../../inter/Atelier_Connexion/loginui.h"
...
QT_MOC_LITERAL(1, 8, 15), // "loginSuccessful"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "role"
QT_MOC_LITERAL(4, 30, 12), // "windowClosed"
QT_MOC_LITERAL(5, 43, 21) // "on_pushButton_clicked"

    },
    "Loginui\0loginSuccessful\0\0role\0"
    "windowClosed\0on_pushButton_clicked"
};
...
void Loginui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginSuccessful((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (Loginui::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Loginui::loginSuccessful)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Loginui::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Loginui::windowClosed)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Loginui::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Loginui.data,
...
// SIGNAL 0
void Loginui::loginSuccessful(int _t1)
{
