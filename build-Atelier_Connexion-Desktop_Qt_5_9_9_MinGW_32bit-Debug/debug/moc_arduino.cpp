...
#include "../../../../../../inter/Atelier_Connexion/arduino.h"
...
QT_MOC_LITERAL(1, 8, 14), // "lumiereChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "valeurLumiere"
QT_MOC_LITERAL(4, 38, 11) // "lireDonnees"

    },
    "Arduino\0lumiereChanged\0\0valeurLumiere\0"
    "lireDonnees"
};
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lumiereChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (Arduino::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arduino::lumiereChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::lumiereChanged(int _t1)
{
